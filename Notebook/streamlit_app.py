...
def load_data():
    try:
        df = pd.read_csv(r'C:\Users\Hp\Desktop\Data_Science_Jupyter\Telecom_Project_5\Data\Final_Data.csv')
        return df
...
with left_column:
    try:
        st.image(Image.open(r'C:\Users\Hp\Desktop\Data_Science_Jupyter\Telecom_Project_5\Notebook\images\streamlit_image.png'))
    except FileNotFoundError:
...
import os
model_path = r'C:\Users\Hp\Desktop\Data_Science_Jupyter\Telecom_Project_5\Notebook\regression_model.pkl'
...
def main():
    ...
    uploaded_file = st.file_uploader(r'C:\Users\Hp\Desktop\Data_Science_Jupyter\Telecom_Project_5\Data\featured_telcom_data.xlsx', type=['xlsx'])
...
with left_column:
    ...
    csv_file_path = r'C:\Users\Hp\Desktop\Data_Science_Jupyter\Telecom_Project_5\Data\Final_Data.csv'
...
with left_column:
    try:
        st.image(Image.open(r'C:\Users\Hp\Desktop\Data_Science_Jupyter\Telecom_Project_5\Notebook\images\top_10_handset.png'))
    except FileNotFoundError:
        st.write('Image file not found')

with left_column:
    st.write('### Top 10 Handset')
    csv_file_path = r'C:\Users\Hp\Desktop\Data_Science_Jupyter\Telecom_Project_5\Data\top_10_handsets.csv'
    if os.path.exists(csv_file_path):
        try:
            data = pd.read_csv(csv_file_path)
            st.dataframe(data)
...
with left_column:
    try:
        st.image(Image.open(r'C:\Users\Hp\Desktop\Data_Science_Jupyter\Telecom_Project_5\Notebook\images\top_3_handset.png'))
    except FileNotFoundError:
        st.write('Image file not found')

with left_column:
    st.write('### Top 3 Manufacturers')
    csv_file_path = r'C:\Users\Hp\Desktop\Data_Science_Jupyter\Telecom_Project_5\Data\top_3_manufacturers.csv'
    if os.path.exists(csv_file_path):
        try:
            data = pd.read_csv(csv_file_path)
            st.dataframe(data)
